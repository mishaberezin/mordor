...
const uploadSomePicturesToVk = async ({ links, vkUploadServer }) => {
    ...
    links.forEach((link, i) => {
        ...
        // form.append(`file${i}`, processPicture(request('https://static-maps.yandex.ru/1.x/?l=map&ll=37.310151%2C55.626167&pt=37.310151%2C55.626167%2Chome&z=13&size=600%2C450')), hasExtHint ? {} : { filename: 'file.jpg' });
    });
