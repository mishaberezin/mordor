...
const getOffers = async (
  ...
  return await Offer.find(filter, null, options)
    .lean()
    .exec();
};
...
const getRawOffers = async (
  ...
  return await RawOffer.find(filter, null, options)
    .lean()
    .exec();
};
...
const countOffers = async (filter = {}) => {
  return Offer.countDocuments(filter).exec();
};
